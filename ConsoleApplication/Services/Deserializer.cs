...
namespace ConsoleApplication.Services
{
	public class Deserializer
	{
		public void Startdeserialize()
		{
			...
			var json5 = @"{	""SubCategories"": [{			""RoleId"": ""1"",			""SubCategoryId"": ""1""		},		{			""RoleId"": ""1"",			""SubCategoryId"": ""2""		},		{			""RoleId"": ""1"",			""SubCategoryId"": ""3""		},		{			""RoleId"": ""2"",			""SubCategoryId"": ""eccolo""		}	]}";
			var obj5 = JsonConvert.DeserializeObject<SubCategoriesObjectt>(json5);
			var ttt = obj5.SubCategories.Where(c => c.RoleId == "2");
			ttt = obj5.SubCategories.Where(c => c.RoleId == "1");
			Console.WriteLine("");
		}
		...
		public class SubCategoriesObjectt
		{
